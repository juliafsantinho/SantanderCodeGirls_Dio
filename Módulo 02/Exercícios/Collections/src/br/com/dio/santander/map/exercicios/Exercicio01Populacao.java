...
public class Exercicio01Populacao {
    public static void main(String[] args) {
        ...
        Map<String,Integer> populacaoEstados3 = new TreeMap<>(populacaoEstadosNE);
        ...
        System.out.println("\n- A soma da população desses estados é " + soma);

        System.out.println("\n- A média da população deste dicionário de estados é " + (soma / populacaoEstadosNE.size()));
        ...
        System.out.println("\n- A lista está vazia? " + populacaoEstadosNE.isEmpty());
